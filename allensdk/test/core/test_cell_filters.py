...
@pytest.fixture
def cells():
    return [{'tld1_id': 177839004,
             'natural_movie_two_small': None,
             'natural_movie_one_a_small': None,
             'speed_tuning_c_large': None,
             'speed_tuning_c_small': None,
             'drifting_grating_small': None,
             'tld1_name': 'Cux2-CreERT2',
             'imaging_depth': 275,
             'tlr1_id': 265943423,
             'pref_dir_dg': None,
             'osi_sg': 0.728589701688166,
             'osi_dg': None,
             'tlr1_name': 'Ai93(TITL-GCaMP6f)',
             'area': 'VISpm',
             'pref_image_ns': 89.0,
             'natural_movie_one_c_small': None,
             'locally_sparse_noise_on_small': None,
             'drifting_grating_large': None,
             'experiment_container_id': 511498500,
             'natural_movie_one_a_large': None,
             'natural_movie_one_c_large': None,
             'tld2_name': 'Camk2a-tTA',
             'p_ns': 2.64407299505246e-05,
             'natural_movie_three_large': None,
             'pref_ori_sg': 30.0,
             'speed_tuning_a_large': None,
             'p_dg': None,
             'time_to_peak_sg': 0.199499999999999,
             'p_sg': 7.60972815250796e-05,
             'time_to_peak_ns': 0.299249999999998,
             'locally_sparse_noise_on_large': None,
             'dsi_dg': None,
             'pref_tf_dg': None,
             'natural_movie_three_small': None,
             'pref_sf_sg': 0.32,
             'tld2_id': 177837320,
             'locally_sparse_noise_off_large': None,
             'locally_sparse_noise_off_small': None,
            ...
            {'tld1_id': 177839004,
             ...
             'imaging_depth': 275,
             'tlr1_id': 265943423,
             'natural_movie_two_large': None,
             'speed_tuning_a_small': None,
             'pref_dir_dg': None,
             'osi_sg': 0.899272239777491,
             'osi_dg': None,
             'tlr1_name': 'Ai93(TITL-GCaMP6f)',
             'area': 'VISpm',
             'pref_image_ns': 15.0,
             ...
             'natural_movie_one_c_large': None,
             'tld2_name': 'Camk2a-tTA',
             'p_ns': 0.000356823517642681,
             'natural_movie_three_large': None,
             'pref_ori_sg': 0.0,
             'speed_tuning_a_large': None,
             'p_dg': None,
             'time_to_peak_sg': 0.565249999999996,
             'p_sg': 0.0565790644804479,
             'time_to_peak_ns': 0.432249999999997,
             'locally_sparse_noise_on_large': None,
             'dsi_dg': None,
             'pref_tf_dg': None,
             'natural_movie_three_small': None,
